...
class UserAccountController extends Controller
{
    ...
    public function get_payment(Request $request,$id)
    {
        ...
        $instamojo_payment = Config::findOrFail(1)->instamojo_payment;
        ...
        return view('subscribe', compact('plan', 'bankdetails', 'account_no', 'account_name', 'ifsc_code', 'bank','razorpay_payment','intent','instamojo_payment'));
    }

                            ...
                            try{
                               ...
                               if (!is_dir(public_path() . '/images/genre')) {
                                ...
                                if (!is_dir(public_path() . '/images/events')) {
                                    mkdir(public_path() . '/images/events');
                                }
                                if (!is_dir(public_path() . '/images/event/thumbnails')) {
                                    mkdir(public_path() . '/images/event/thumbnails');
                                }
                                if (!is_dir(public_path() . '/images/audio')) {
                                    mkdir(public_path() . '/images/audio');
                                }
                                if (!is_dir(public_path() . '/images/audio/posters')) {
                                    mkdir(public_path() . '/images/audio/posters');
                                }
                                if (!is_dir(public_path() . '/images/audio/thumbnails')) {
                                    mkdir(public_path() . '/images/audio/thumbnails');
                                }

...
<html lang="en">
  ...
  <body class="body">
        ...
        <div class="display-none preloader3"></div>
          ...
          <div class="card-header">
              <h3 class="m-3 text-center heading">
                  <?php echo e(__('Installing Nexthour')); ?>

              </h3>
          </div>
   				<div class="card-body" id="stepbox">
               <form action="<?php echo e(route('store.eula')); ?>" id="step1form" method="POST" class="needs-validation" novalidate>
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-row">
                   ...
                   <div class="col-md-12">
                      ...
                      <b><?php echo e(__('Note')); ?>:</b> <span class="text-dark font-weight-normal">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header card-header">
                <h4 class="modal-title heading" id="myModalLabel"><?php echo e(__('Welcome To Setup Wizard')); ?> </h4>
                </button>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6 custom-control custom-checkbox">
                     <input  type="radio" class="custom-control-input" id="customCheck3" name="user" value="existing"/>&nbsp;
                      <label class="custom-control-label" for="customCheck3"><b><?php echo e(__('I\'m Existing user')); ?></b></label>
                  </div>
                  <div class="col-md-6 custom-control custom-checkbox">
                      <input type="radio" class="custom-control-input" id="customCheck4" name="user" value="new"/> &nbsp;
                      <label class="custom-control-label" for="customCheck4"><b><?php echo e(__('I\'m New user')); ?></b></label>
                  </div>
                </div>
      ...
      <div class="corner-ribbon bottom-right sticky green shadow"><?php echo e(__('EULA')); ?> </div>
       <?php echo notify_js(); ?>
        ...
        $("input[type='button']").click(function(){
            ...
            if(radioValue == 'new'){
              ...
              <?php
               ...
               ?>
               window.location = "<?php echo e(route('existterm')); ?>";
            }
          });
      });
    </script>
...
</html><?php /**PATH /var/www/httv/public/uploads/dungthinh/nh_2021/resources/views/install/eula.blade.php ENDPATH**/ ?>
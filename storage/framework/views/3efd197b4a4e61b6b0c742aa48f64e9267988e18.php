          ...
          <div class="payment-gateway-block">
           ...
           <div class="payment-gateway-block">
              <div class="form-group">
                  <div class="row">
                    <div class="col-xs-6">
                      <?php echo Form::label('instamojo_payment', 'INSTAMOJO PAYMENT'); ?>

                      <label> (Indian Currency)</label>
                    </div>
                    <div class="col-xs-5 text-right">
                      <label class="switch">
                ...
                <div id="instamojo_box" style="<?php echo e($config->instamojo_payment == 1 ? "" : "display:none"); ?>">
                    <div class="form-group">
                        ...
                        <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter api key"></i>
                        <input type="text" name="IM_API_KEY" value="<?php echo e($env_files['IM_API_KEY']); ?>" class="form-control">
                      </div>
      
                      <div class="form-group">
                          <label>INSTAMOJO AUTH TOKEN: </label>
                          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter instamojo auth token key"></i>
                          <input type="text" name="IM_AUTH_TOKEN" value="<?php echo e($env_files['IM_AUTH_TOKEN']); ?>" class="form-control">
                      </div>
                     
                      <div class="form-group">
                          <label>INSTAMOJO PAYMENT URL: </label>
                          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter instamojo url"></i>
                          <input type="text" name="IM_URL" value="<?php echo e($env_files['IM_URL']); ?>" class="form-control">
                      </div>
                      <small class="text-danger">
                        Note :- <br/>
                        <b>- For testing mode payment url is https://test.instamojo.com/api/1.1/<br/>
                        - For Live mode payment url is https://www.instamojo.com/api/1.1/</b>
                      </small>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/httv/public/uploads/dungthinh/nh_2021/resources/views/admin/config/api.blade.php ENDPATH**/ ?>
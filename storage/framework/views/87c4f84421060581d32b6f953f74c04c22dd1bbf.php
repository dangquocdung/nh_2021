                       ...
                       <div class="col-sm-7">
                          ...
                          <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                 <input type="checkbox" name="enable_messanger[<?php echo e($element->id); ?>]" <?php echo e($element->enable_messanger == 1 ? 'checked' :''); ?> class='bootswitch' data-on-text="ON" data-off-text = "OFF" data-size="small">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-group<?php echo e($errors->has('enable_whatsapp') ? ' has-error' : ''); ?>">
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                <input type="checkbox" name="enable_whatsapp[<?php echo e($element->id); ?>]" <?php echo e($element->enable_whatsapp == 1 ? 'checked' :''); ?> class='bootswitch' data-on-text="ON" data-off-text = "OFF" data-size="small">
                  ...
                  <div class="col-md-3">
                      <div class="form-group<?php echo e($errors->has('position') ? ' has-error' : ''); ?>">
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                <input type="checkbox" name="position[<?php echo e($element->id); ?>]" <?php echo e($element->position == 'left' ?'checked' :''); ?> class='bootswitch' data-on-text="Left" data-off-text = "Right" data-size="small">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/httv/public/uploads/dungthinh/nh_2021/resources/views/admin/chat_setting/index.blade.php ENDPATH**/ ?>
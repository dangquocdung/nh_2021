                            ...
                            <img src="{{url('images/logo/'.$logo)}}" class="img-responsive" alt="{{$w_title}}">
                              ...
                              <div class="row">
                                 <div class="des-btn-block des-in-list">
                                    ...
                                    @if($auth && $subscribed ==1)
                                      <a class="btn btn-play" href="{{url('movie/detail',$item->slug)}}"><i class="fa fa-info-circle"></i> {{__('staticwords.moreinfo')}}</a>
                                    @else
                                      <a class="btn btn-play" href="{{url('movie/guest/detail',$item->slug)}}"><i class="fa fa-info-circle"></i> {{__('staticwords.moreinfo')}}</a>
                                    @endif
                                  </div>
                                </div>
                                <br/>
                            ...
                            <div>
                             <div class="des-btn-block des-in-list">
                                ...
                                @if($subscribed == 1 && $auth)
                                  <a class="btn btn-play" @if(isset($gets1)) href="{{url('show/detail',$gets1->season_slug)}}" @endif><i class="fa fa-info-circle"></i> {{__('staticwords.moreinfo')}}</a>
                                @else
                                  <a class="btn btn-play" @if(isset($gets1)) href="{{url('show/guest/detail',$gets1->season_slug)}}" @endif><i class="fa fa-info-circle"></i> {{__('staticwords.moreinfo')}}</a>

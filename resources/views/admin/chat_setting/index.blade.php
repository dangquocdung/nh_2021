                       ...
                       <div class="col-sm-7">
                          ...
                          <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                 <input type="checkbox" name="enable_messanger[{{ $element->id }}]" {{ $element->enable_messanger == 1 ? 'checked' :'' }} class='bootswitch' data-on-text="ON" data-off-text = "OFF" data-size="small">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-group{{ $errors->has('enable_whatsapp') ? ' has-error' : '' }}">
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                <input type="checkbox" name="enable_whatsapp[{{ $element->id }}]" {{ $element->enable_whatsapp == 1 ? 'checked' :'' }} class='bootswitch' data-on-text="ON" data-off-text = "OFF" data-size="small">
                  ...
                  <div class="col-md-3">
                      <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-5 pad-0">
                            <div class="make-switch">
                                <input type="checkbox" name="position[{{ $element->id }}]" {{ $element->position == 'left' ?'checked' :'' }} class='bootswitch' data-on-text="Left" data-off-text = "Right" data-size="small">

  ...
  <aside class="main-sidebar" style="background-image: url({{url('images/sidebar-7.jpg')}});">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a class="{{ Nav::isRoute('pwa.setting.index') }}" href="{{route('pwa.setting.index')}}" title="PWA Settings"><i class="material-icons">devices_other</i> <span>PWA Settings</span></a></li>

         <li><a class="{{ Nav::isRoute('admin.backup.settings') }}" href="{{route('admin.backup.settings')}}" title="Database Backup"><i class="material-icons">settings_backup_restore</i> <span>Database Backup</span></a></li>
